...
output_csv = "one_aircraft_data.csv"
...
# # Draw a 3D route
# df = df.dropna(subset=["baro_altitude", "longitude", "latitude"])

# fig = plt.figure(figsize=(10, 7))
# ax = fig.add_subplot(111, projection='3d')

# ax.plot(df["longitude"], df["latitude"], df["baro_altitude"],
#         marker='o', linestyle='-', color='blue')

# ax.set_title(f"3D Flight Path of Aircraft {icao24_list[0]}")
# ax.set_xlabel("Longitude")
# ax.set_ylabel("Latitude")
# ax.set_zlabel("Barometric Altitude (m)")
